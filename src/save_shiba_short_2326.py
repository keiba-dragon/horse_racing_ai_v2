# coding: utf-8
"""
save_shiba_short_2326.py - 芝短距離モデル保存 (v3.0: 2326選択指標)
  2326(選択)=+11.35%  2323=+11.27%  2025=+2.74%  2026=+61.72%  25+26=+21.60%
  特徴量(10個): ['馬番', '斤量', '馬体重', '馬距離_勝率', '1走前_クラス差',
                '近5走_上り3F平均', '性別_num', 'ブリンカー変更', 'コース枠_r200_勝率', '1走前_馬場状態']
  セグメント: 芝 ≤1400m & クラス_rank!=1.0（新馬除外）
...
FEATS = ['馬番', '斤量', '馬体重', '馬距離_勝率', '1走前_クラス差',
         '近5走_上り3F平均', '性別_num', 'ブリンカー変更', 'コース枠_r200_勝率', '1走前_馬場状態']
L2 = 0.006
...
def main():
    print('=' * 60)
    print('  芝短距離 モデル保存 v3.0 (2326選択指標)')
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_shiba_short_2326.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝短v3(10特徴,2326選択)',
        'version':       'shiba_short_2326',
    }
