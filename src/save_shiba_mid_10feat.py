# coding: utf-8
"""
save_shiba_mid_10feat.py - 芝中距離 10特徴モデル保存
...
FEATS = [
    '調教師コース_r100_勝率', '馬距離_勝率', '1走前_クラス調整着順', '近5走_クラス調整_平均着順', '間隔',
    '馬番', '前走着差タイム', '良馬場_平均着順_近5走', '2走前_クラス差', 'コース枠_r200_勝率',
]
L2 = 0.006
...
def main():
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中10特徴更新(2323選択)',
        'version':       'shiba_mid_10feat',
    }
    ...
    print('=== 芝中距離 10特徴 保存完了 ===')
    print(f'  2323: -6.52% (AI比 +11.21pp)')
