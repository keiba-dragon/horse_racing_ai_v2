# coding: utf-8
"""
save_da_short_nv3.py - ダ短距離 nv3 モデル保存
...
FEATS = [
    '近5走_上り3F平均', 'コース枠_r200_勝率', '1走前_馬場状態', '1走前_クラス差', '2走前_クラス差',
    '性別_num', '斤量', '同会場_平均着順_近5走', '馬体重', '馬距離_勝率',
]
L2 = 0.006
...
def main():
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | ダ短nv3更新(10特徴,2323選択)',
        'version':       'da_short_nv3',
    }
    ...
    print()
    print('=== ダ短距離 nv3 保存完了 ===')
    print(f'  特徴量: {len(valid_feats)}個  L2=0.006  isotonic calibrated')
    print(f'  選択指標(2323): +8.81%')
    print(f'  25+26 OOS ROI: {comb:+.2%}')
