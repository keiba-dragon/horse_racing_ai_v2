# coding: utf-8
"""
save_shiba_short_nv2.py - 芝短距離 nv2 モデル保存
  特徴量(10個): 1走前_3角, 芝ダ転向, 距離変化_前走, 1走前_脚質_num,
...
def main():
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝短nv2更新',
        'version':       'shiba_short_nv2',
    }
    ...
    print(f'  25+26 OOS ROI: {comb:+.2%}  (nv1比 +17.43pp, タイ率 29.9%→0.8%)')
