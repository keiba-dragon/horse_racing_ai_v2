# coding: utf-8
"""
save_shiba_mid_ai.py - 芝中距離 AI モデル保存
...
def main():
    ...
    new_artifacts['芝中'] = shiba_mid_art
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中AI追加',
        'version':       'shiba_mid_ai',
    }
    ...
    print()
    print('=== 芝中距離 AI 保存完了 ===')
    print(f'  芝中 artifact: AI (5特徴, L2=0.006, isotonic calibrated)')
    print(f'  25+26 OOS ROI: {comb:+.2%}  (ベースライン比 +31.02pp vs -22.21%)')
