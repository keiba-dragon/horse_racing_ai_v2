...
def main():
    ...
    new_artifacts['芝長'] = shiba_long_art
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝長Y8追加',
        'version':       'shiba_long_y8',
    }
    ...
    print()
    print('=== 芝長距離 Y8 保存完了 ===')
    print(f'  芝長 artifact: Y8 (5特徴, L2=0.006, isotonic calibrated)')
    print(f'  25+26 OOS ROI: {comb:+.2%}  (filtered baseline比 +17.50pp vs -20.53%)')
    print(f'  ※ 予測コード (06_predict_from_card.py) の距離分岐を次に更新予定')
