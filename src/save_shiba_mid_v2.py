# coding: utf-8
"""
save_shiba_mid_v2.py - 芝中距離モデル保存 (v2.0: 2325選択指標)
...
def main():
    print('=' * 60)
    print('  芝中距離 モデル保存 v2.0 (2325選択指標)')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中v2(5特徴,2325選択)',
        'version':       'shiba_mid_v2',
    }
