# coding: utf-8
"""
save_shiba_mid_acc.py - 芝中距離 的中率最大化モデル保存

  v2ベスト35特徴  acc_2325=30.25%  ランダム比3.987x
  セグメント: 芝 & 1400m<距離≤2000m & クラス_rank≠1.0  1番人気33.21%
...
FEATS = [
    ...
    'コース脚質_r200_勝率', '上り3F_近3走_slope', 'タイム指数_近5走_slope',
    '馬体重増減', '同会場_平均着順_近5走',
]
L2 = 0.006
...
def main():
    print('=' * 70)
    print('  芝中距離 的中率モデル保存 (v2: 35特徴, acc_2325=30.25%)')
    ...
    acc_pkg = {
        'segment': '芝中 1400m<距離≤2000m クラス_rank≠1.0',
        'scaler': scaler,
        'coef': beta,
        ...
        'version': 'shiba_mid_acc_v2',
        'note': f'v2: 35特徴 acc_2325={acc_2325:.4f} ランダム比3.987x 1番人気33.21%',
    }
