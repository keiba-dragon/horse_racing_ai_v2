# coding: utf-8
"""
save_shiba_mid_v4.py - 芝中距離モデル保存 (v4.0: 近5走_上り3F_std強制ベース版)
  2323=+4.57%  2025=-9.84%  2026=+41.81%  25+26=+7.31%
  特徴量(10個): ['馬番','斤量','近5走_上り3F_std','馬距離_勝率','種牡馬_勝率',
                '間隔','ブリンカー変更','コース枠_r200_勝率','芝ダ転向','3走前_クラス差']
  セグメント: 芝 1401m-2000m
...
FEATS = ['馬番', '斤量', '近5走_上り3F_std', '馬距離_勝率', '種牡馬_勝率',
         '間隔', 'ブリンカー変更', 'コース枠_r200_勝率',
         '芝ダ転向', '3走前_クラス差']
L2 = 0.006
...
def main():
    print('=' * 60)
    print('  芝中距離 モデル保存 v4.0 (近5走_上り3F_std強制ベース版)')
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_shiba_mid_v4.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中v4(10特徴,近5走_上り3F_std強制ベース)',
        'version':       'shiba_mid_v4',
    }
