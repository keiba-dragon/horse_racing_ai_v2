# coding: utf-8
"""
save_da_short_2325.py - ダ短距離モデル保存 (2325選択指標)
  特徴量(10個): ['馬番', '斤量', '種牡馬_勝率', '間隔', '2走前_クラス差',
                'コース枠_r200_勝率', '1走前_馬場状態', '1走前_クラス差',
                '3走前_クラス差', 'ブリンカー変更']
  2325=-2.97%  2323=-6.87%  2025=+4.94%  2026=-35.37%  25+26=-7.00%
...
def main():
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_da_short_2325.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | ダ短2325(10特徴,25+26=-7.00%)',
        'version':       'da_short_2325',
    }
    ...
    print('=== ダ短距離 2325 保存完了 ===')
    print(f'  2325: -2.97% (選択指標)')
