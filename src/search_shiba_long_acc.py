# coding: utf-8
"""
search_shiba_long_acc.py - 芝長距離 特徴量探索 (的中率最大化版)

セグメント: 芝 & 距離>2000m & クラス_rank≠1.0
選択指標: acc_2325 = (acc2324×n2324 + acc25×n25) / (n2324+n25)  ← 的中率
ROIは参考値として表示。保存先: models/hitrate_model.pkl（roi_model.pkl上書き禁止）

1番人気 acc_2325=36.05%（ランダム8.1%）
v1: ゼロシードからクリーン探索、MAX_FEATS=30 → acc_2325=34.75%
...
L2 = 0.006
MAX_FEATS = 35
ACC_TARGET = 0.36  # 目標: 1番人気acc_2325=36.05%に近づける

FORCED_BASE = ['馬番', '斤量']
# v1結果30特徴をシードに設定
SEED_FEATS = [
    '馬番', '斤量', '近3走_複勝率', '騎手距離_r100_勝率', '近5走_タイム指数平均',
...
def main():
    t0 = time.time()
    print("=" * 90)
    print("  芝長距離 特徴量探索 — 選択指標=的中率(acc_2325)  ※ROIモデルとは別物")
    print("  セグメント: 芝 & 距離>2000m & クラス_rank≠1.0")
    print("  1番人気 acc_2325=36.05%  ランダム=8.1%")
    print("=" * 90)
    ...
    print(f"  目標: 1番人気 acc_2325=36.05%")
