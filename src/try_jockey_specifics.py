# coding: utf-8
"""
try_jockey_specifics.py - 騎手・調教師の特化指標テスト
  未テストの候補:
    - 騎手コース距離_r100_勝率/複勝率  (コース×距離の組み合わせ)
    - 騎手脚質_r100_勝率/複勝率        (脚質別騎手勝率)
    - 騎手調教師_r100_勝率/複勝率      (騎手×調教師コンボ)
    - 騎手距離_r100_勝率/複勝率        (距離別騎手勝率)
    - 騎手馬場_r100_勝率/複勝率        (馬場状態別騎手勝率)
    - 調教師_r200_勝率                 (調教師長期勝率)
...
def main():
    ...
    print()
    print('=== 騎手/調教師特化指標テスト (BASE_25 + L2=0.006) ===')
    print()
