# coding: utf-8
"""
search_shiba_mid_acc.py - 芝中距離 特徴量探索 (的中率最大化版)

セグメント: 芝 & 1400m<距離≤2000m & クラス_rank≠1.0
選択指標: acc_2325 = (acc2324×n2324 + acc25×n25) / (n2324+n25)  ← 的中率
ROIは参考値として表示。保存先: models/hitrate_model.pkl（roi_model.pkl上書き禁止）

1番人気 acc_2325=33.21%（ランダム7.5%）
v1: ゼロシードからクリーン探索、MAX_FEATS=30 → acc_2325=30.21%
...
L2 = 0.006
MAX_FEATS = 35
ACC_TARGET = 0.33  # 目標: 1番人気acc_2325=33.21%に近づける
...
def main():
    t0 = time.time()
    print("=" * 90)
    print("  芝中距離 特徴量探索 — 選択指標=的中率(acc_2325)  ※ROIモデルとは別物")
    print("  セグメント: 芝 & 1400m<距離≤2000m & クラス_rank≠1.0")
    print("  1番人気 acc_2325=33.21%  ランダム=7.5%")
    print("=" * 90)
    ...
    print(f"  目標: 1番人気 acc_2325=33.21%")
