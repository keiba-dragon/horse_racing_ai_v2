# coding: utf-8
"""
save_da_long_acc.py - ダ長距離 的中率最大化モデル保存

  v7ベスト36特徴  acc_2325=30.02%  ランダム比4.077x
...
FEATS = [
    ...
    '近3走_勝率', 'コース枠_r200_複勝率', '馬_r20_勝率', '性別_num',
    '騎手会場_r100_勝率', '相手レベル_平均着順',
]
L2 = 0.006
...
def main():
    print('=' * 70)
    print('  ダ長距離 的中率モデル保存 (v7: 36特徴, acc_2325=30.02%)')
    ...
    acc_pkg = {
        ...
        'version': 'da_long_acc_v7',
        'note': f'v7: 36特徴 acc_2325={acc_2325:.4f} ランダム比4.077x',
    }
