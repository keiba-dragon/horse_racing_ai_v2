# coding: utf-8
"""
search_shiba_mid_2325_v3.py - 芝中距離 特徴量探索 (2325選択指標)

v3.0: 近5走_上り3F_stdを強制ベースに追加して探索。
  2026年ROI改善狙い（単独で2026=+26.92%の効果あり）。
  セグメント: 芝 1401m-2000m
"""
...
FORCED_BASE = ['馬番', '斤量', '近5走_上り3F_std']
...
CANDIDATES = [
    ...
    '近5走_上り3F平均',
    # ※除外: '近5走_上り3F_std'（FORCED_BASEに移動）
    # クラス差
    ...
    '馬体重', '芝ダ転向', '距離変化_前走',
    # その他
    '性別_num', 'ブリンカー変更', '種牡馬_勝率', '近3走_複勝率',
    # ※除外: '騎手変更'（人気薄騎手変更馬を選びやすい・2026阪神で破綻）
    # ※除外: '道悪_平均着順_近5走'（NaN率74%超）
]
...
def main():
    t0 = time.time()
    print("=" * 90)
    print("  芝中距離 特徴量探索 v3.0 — 選択指標=2325(2023-25合算) OOS ROI")
    print("  近5走_上り3F_std強制ベース版。2026は参考値のみ。")
    print("=" * 90)
