# coding: utf-8
"""
save_shiba_mid_v3.py - 芝中距離モデル保存 (v3.0: 2325選択指標 性別_num版)
  2025=-15.82%  2026=-23.26%  25+26=-18.30%(推定)
  特徴量(10個): ['馬番','斤量','種牡馬_勝率','馬距離_勝率','3走前_クラス差',
                'ブリンカー変更','近5走_上り3F平均','コース枠_r200_勝率','1走前_馬場状態','性別_num']
  セグメント: 芝 1401m-2000m
...
FEATS = ['馬番', '斤量', '種牡馬_勝率', '馬距離_勝率', '3走前_クラス差',
         'ブリンカー変更', '近5走_上り3F平均', 'コース枠_r200_勝率',
         '1走前_馬場状態', '性別_num']
L2 = 0.006
...
def main():
    print('=' * 60)
    print('  芝中距離 モデル保存 v3.0 (2325選択指標 性別_num版)')
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_shiba_mid_v3.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中v3(10特徴,2325選択_性別_num版)',
        'version':       'shiba_mid_v3',
    }
