# coding: utf-8
"""
save_shiba_mid_2326.py - 芝中距離モデル保存 (v3.0: 2326選択指標)
  2326(選択)=+5.21%  2323=+11.67%  2025=-14.35%  2026=+19.25%  25+26=-3.20%
  特徴量(10個): ['馬番', '斤量', '種牡馬_勝率', '性別_num', '3走前_クラス差',
                '道悪_平均着順_近5走', '距離変化_前走', 'コース枠_r200_勝率', '間隔', '近5走_上り3F平均']
...
FEATS = ['馬番', '斤量', '種牡馬_勝率', '性別_num', '3走前_クラス差',
         '道悪_平均着順_近5走', '距離変化_前走', 'コース枠_r200_勝率', '間隔', '近5走_上り3F平均']
L2 = 0.006
...
def main():
    print('=' * 60)
    print('  芝中距離 モデル保存 v3.0 (2326選択指標)')
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_shiba_mid_2326.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝中v3(10特徴,2326選択)',
        'version':       'shiba_mid_2326',
    }
