# coding: utf-8
"""
save_da_long_2325.py - ダ長距離モデル保存 (2325選択指標)
  特徴量(10個): ['馬番', '斤量', '種牡馬_勝率', '性別_num', 'ブリンカー変更',
                '近5走_上り3F平均', '1走前_馬場状態', '2走前_クラス差',
                'コース枠_r200_勝率', '3走前_クラス差']
  2325=-1.17%  2323=-10.08%  2025=+16.58%  2026=-36.50%  25+26=+1.11%
  セグメント: ダ & >1400m & クラス_rank≠1.0
  roi_model.pkl の 'ダ' artifact を上書き更新。
"""
...
def main():
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_da_long_2325.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | ダ長2325(10特徴,25+26=+1.11%)',
        'version':       'da_long_2325',
    }
    ...
    print('=== ダ長距離 2325 保存完了 ===')
    print(f'  2325: -1.17% (選択指標)')
