# coding: utf-8
"""
save_shiba_short_v3.py - 芝短距離モデル保存 (v3.0: 2325選択指標 脚質系除外版)
  2325=+15.47%  2023=+23.26%  2025=-0.07%  2026=-15.15%  25+26=-4.89%
  特徴量(10個): ['馬番','斤量','馬体重','馬距離_勝率','コース枠_r200_勝率',
                '性別_num','近5走_上り3F平均','近5走_上り3F_std','距離変化_前走','ブリンカー変更']
  セグメント: 芝 ≤1400m
...
FEATS = ['馬番', '斤量', '馬体重', '馬距離_勝率',
         'コース枠_r200_勝率', '性別_num', '近5走_上り3F平均',
         '近5走_上り3F_std', '距離変化_前走', 'ブリンカー変更']
L2 = 0.006
...
def main():
    print('=' * 60)
    print('  芝短距離 モデル保存 v3.0 (2325選択指標 脚質系除外版)')
    ...
    backup_path = os.path.join(MODEL_DIR, 'final_model_pre_shiba_short_v3.pkl')
    ...
    new_pkg = {
        ...
        'note':          existing_pkg.get('note', '') + ' | 芝短v3(10特徴,2325選択脚質除外)',
        'version':       'shiba_short_v3',
    }
