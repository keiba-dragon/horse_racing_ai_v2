# coding: utf-8
"""
save_da_short_acc.py - ダ短距離 的中率最大化モデル保存

  v3ベスト40特徴  acc_2325=30.79%  ランダム比4.557x
...
def main():
    print('=' * 70)
    print('  ダ短距離 的中率モデル保存 (v3: 40特徴, acc_2325=30.79%)')
    ...
    acc_pkg = {
        ...
        'version': 'da_short_acc_v3',
        'note': f'v3: 40特徴 acc_2325={acc_2325:.4f} ランダム比4.557x',
    }
