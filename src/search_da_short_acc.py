# coding: utf-8
"""
search_da_short_acc.py - ダ短距離 特徴量探索 (的中率最大化版)
...
v1: ゼロシードからクリーン探索、MAX_FEATS=30 → acc_2325=29.70%
v2: v1の30特徴をSEEDに、MAX_FEATS=35 → acc_2325=30.59%
v3: v2の35特徴をSEEDに、MAX_FEATS=40 → acc_2325=30.79%
v4: v3の40特徴をSEEDに、MAX_FEATS=45  目標: 1番人気acc_2325=34.90%に近づける
"""
import sys, os, time
import numpy as np
import pandas as pd
...
L2 = 0.006
MAX_FEATS = 45
ACC_TARGET = 0.34  # 目標: 1番人気acc_2325=34.90%に近づける
...
def main():
    t0 = time.time()
    print("=" * 90)
    print("  ダ短距離 特徴量探索 — 選択指標=的中率(acc_2325)  ※ROIモデルとは別物")
