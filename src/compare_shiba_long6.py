# coding: utf-8
"""
compare_shiba_long6.py - 芝長距離（芝2001m以上）Round 6
* Round5 best: Y8=-3.03% (前走着差タイム, 距離変化_前走, 1走前_クラス差, 馬距離_勝率, 間隔)
* Y8 のバリエーションで安定性確認
...
# Y8: 前走着差タイム, 距離変化_前走, 1走前_クラス差, 馬距離_勝率, 間隔 → -3.03%
SETS = {
    'Y8: R5best(再確認)':            ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔'],
    'Z1: Y8+3角':                   ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '1走前_3角'],
    'Z2: Y8+調教師':                 ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '調教師コース_r100_勝率'],
    'Z3: Y8+騎手':                  ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '騎手コース_r100_勝率'],
    'Z4: Y8-クラス差':               ['前走着差タイム', '距離変化_前走', '馬距離_勝率', '間隔'],
    'Z5: Y8-距離変化':               ['前走着差タイム', '1走前_クラス差', '馬距離_勝率', '間隔'],
    'Z6: Y8+2走クラス差':            ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '2走前_クラス差'],
    'Z7: Y8+クラス調整':              ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '1走前_クラス調整着順'],
    'Z8: Y8+5走補正':               ['前走着差タイム', '距離変化_前走', '1走前_クラス差',
                                     '馬距離_勝率', '間隔', '近5走_クラス調整_平均着順'],
}
...
def main():
    ...
    FILTERED_BL = -0.2053
    print("=" * 72)
    print("  芝長距離（芝2001m以上）Round 6")
    print(f"  Round5 best Y8=-3.03%  filtered baseline={FILTERED_BL*100:.2f}%")
    ...
    print(f"  Round5 best比 (Y8=-3.03%): {(best_comb+0.0303)*100:+.2f}pp")
