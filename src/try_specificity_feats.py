# coding: utf-8
"""
try_specificity_feats.py - 特殊性・マッチング系特徴量テスト
  BASE_25 = BASE_24 + タイム指数_近5走_slope をベースに
  特定コース/距離/馬場適性などのマッチング特徴量を試験

  新規候補:
    - 種牡馬_ダ_勝率: ダート専用種牡馬勝率 (種牡馬_勝率より適切)
    - 種牡馬_ダ_複勝率
    - 母父馬_勝率, 母父馬_複勝率
    - コース枠_r200_勝率: 枠×コース勝率
    - コース脚質_r200_勝率: 脚質×コース勝率
    - コース馬場_r200_勝率: 馬場×コース勝率
    - 同会場_複勝率_近5走
    - 生産者_勝率
    - 馬コース_r20_勝率: この馬のこのコース勝率
    - 馬距離_勝率, 馬距離_複勝率: この馬のこの距離勝率
    - 近10走_勝率, 近10走_複勝率
    - 調教師_r200_勝率
    - 騎手_r200_勝率
"""
...
def main():
    ...
    print('=== 特殊性・マッチング系特徴テスト (BASE_25 + L2=0.006) ===')
    print()
    ...
    for d, c in positives:
        ...
        if comb > current_c:
            ...
            current_c = comb
            added.append(c)
            print(f'    → 採用 (累計: {current_c:+.2%})')
        else:
            print(f'    → 棄却')

    print()
    print(f'最終特徴数: {len(current_feats)}F')
    print(f'最終25+26: {current_c:+.2%}')
